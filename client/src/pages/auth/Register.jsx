...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // You can add your registration API call or context function here
  };

  return (
    <div className="font-sans bg-white text-white md:h-screen">
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          <form onSubmit={handleSubmit} className="max-w-lg w-full mx-auto">
            ...
            <div>
              <label htmlFor="name" className="text-xs block mb-2">
                Full Name
              </label>
            ...
            <div className="mt-12">
              <button
                type="submit"
                className="w-max shadow-xl py-2.5 px-8 text-sm font-semibold rounded-md bg-transparent text-yellow-400 border border-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              >
                Register
              </button>
